...
- `.claude/sessions/` – Session history and CURRENT.md state tracking
- `.claude/reference/` – Reference documentation (this file)
- `.claude/.claudeignore` – Protected paths and sensitive files
