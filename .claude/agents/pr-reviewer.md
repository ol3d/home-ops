---
name: pr-reviewer
description: Reviews pull requests holistically, analyzing multiple commits, PR description quality, testing coverage, and cross-file impact. Invoked when creating or reviewing PRs.
model: sonnet
color: purple
---
...
**Pre-Commit Reviewer** (different agent):
...
- `.claudeignore` and `.gitignore` respected
...
- Expose contents of `.claudeignore` files
